...
首先明确64位linux一般使用48位来表示虚拟地址空间，使用40位来表示物理地址空间。其中，0x0000000000000000~0x00007fffffffffff 表示用户空间，用户空间的第48位其实没有用，一直是0，用户空间可用的是有47位 ，剩下的从0xFFFF800000000000~ 0xFFFFFFFFFFFFFFFF 表示内核空间，
